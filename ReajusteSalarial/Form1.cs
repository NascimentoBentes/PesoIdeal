...
namespace ReajusteSalarial
{
    public partial class FormCalculoDeSalario : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            RadioButton rbnCategoria = gbxCategoria.Controls.OfType
                <RadioButton>().SingleOrDefault(r => r.Checked);
        ...
        private void ApresentarResultados(
            double valorCoeficiente, double valorSalarioBruto,
            double valorImposto, double valorGratificacao,
            double valorAuxilioAlimentacao, double valorSalarioLiquido)
        {
            txtClassificacao.Text = GetClassificacao(valorSalarioLiquido);
        ...
        private string GetClassificacao(double valorSalarioLiquido)
        {
        ...
        private void FormCalculoDeSalario_Load(object sender, EventArgs e)
        {
